...
{ 
	if(item != "" && sortname != "") 
	{ 
		window.top.frames['tagFrame'].getObject('show_text').innerHTML = sortname + "  <img src=images/slide.gif broder=0 />  " + item 
	} 
	if(src != "") 
	{ 
...
t=outlookbar.addtitle('退出系统','0',1)
outlookbar.additem('点击退出登录',t,'index.do?method=loginOut')
</script>
</head>
