...
function miniGameFormValidate() {
	...
	$('#adImgFile').formValidator( {
		onshow :"请选择 jpg|jpeg|png|bmp|gif 类型的小游戏广告文件, 可以不修改",
		oncorrect :"输入正确",
		empty :true,
		onfocus :"你要是输入了, 必须输入正确",
		onempty :"你真的不想修改小游戏广告文件?",
		tipid :"adImgFileTip"
	}).inputValidator( {
		max :"64",
		min :"1",
	...
	$('#adHref').formValidator( {
		onshow :"请输入小游戏广告链接, 可以不修改",
		oncorrect :"输入正确",
		empty :true,
		onfocus :"你要是输入了, 必须输入正确",
		onempty :"你真的不想修改小游戏广告链接?",
		tipid :"adHrefTip"
	}).inputValidator( {
		max :"64",
		min :"1",
	...
	$('#adTitle').formValidator( {
		onshow :"请输入小游戏广告标题, 可以不修改",
		oncorrect :"输入正确",
		empty :true,
		onfocus :"你要是输入了, 必须输入正确",
		onempty :"你真的不想修改小游戏广告标题?",
		tipid :"adTitleTip"
	}).inputValidator( {
		max :"64",
		min :"1",
...
function miniGameClsFormValidate() {
	...
	$('#iconFile').formValidator( {
		onshow :"请选择 jpg|jpeg|png|bmp|gif 类型的图标文件",
		oncorrect :"输入正确",
		empty :true,
		onfocus :"图标文件可以不修改",
		onempty :"你真的不想修改图标?",
...
function voteFormFormValidate() {
	...
	$('#isLoginRequired').formValidator( {
		onshow :"请选择需要或不需要",
		oncorrect :"输入正确",
		empty :false,
		onfocus :"是否登录不能为空",
		tipid :"isLoginRequiredTip"
	}).inputValidator( {
		max :"3",
		min :"1",
		empty :false,
		onerror :"是否登录为空或长度不正确"
	}).regexValidator( {
		regexp :"intege1",
		datatype :"enum",
		onerror :"你输入的必须是正整数"
