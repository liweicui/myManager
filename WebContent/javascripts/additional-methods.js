...
// 验证账户名只能是字母和数字
jQuery.validator.addMethod("userformat", function(value, element, param) {
	return this.optional(element) || /^[A-Za-z0-9]+$/.test(value);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
}, jQuery.validator.messages.userformat);

//验证密码只能是字母和数字
jQuery.validator.addMethod("passformat", function(value, element, param) {
	return this.optional(element) || /^[A-Za-z0-9]+$/.test(value);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
}, jQuery.validator.messages.passformat);

//验证账户名第一个字符必须是字母
jQuery.validator.addMethod("userfristchar", function(value, element, param) {
	return this.optional(element) || /^[a-zA-Z]{1}$/.test(value.substr(0,1));                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
}, jQuery.validator.messages.userfristchar);
//验证是否是固定电话
jQuery.validator.addMethod("Telphone", function(value, element, param) {
	return this.optional(element) || /^((\(\d{3}\))|(\d{3}\-))?(\(0\d{2,3}\)|0\d{2,3}-)?[1-9]\d{6,7}(\-\d{1,4})?$/.test(value);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
}, jQuery.validator.messages.telphone);
//验证是否是手机号
...
//验证是否是邮政编码
jQuery.validator.addMethod("Zip", function(value, element, param) {
...
}, jQuery.validator.messages.Chinese);
