...
(function ($) {
  ...
  SlickGrid.prototype = {
    ...
    handleCreate: function () {
      ...
      this.grid = new Slick.Grid(this.element, o.data,
  ...
  $.extend(true, $.SlickGrid , {
      "Formatter":{
          "integer" :function(row, cell, value, columnDef, dataContext){
             return value.format();
          },
          "double" : function(row, cell, value, columnDef, dataContext){
          ...
          "percent": function(row, cell, value, columnDef, dataContext){
              return $.format("{0}%", (value.format(2) * 100));
          },
