(function ($) {
    ...
    var datepickerOptions = {
        ...
        //picker
        $(rangeInput).data('rangepicker',{
            setRange: function(startDate, endDate ){
                var rangeA,rangeB;
                rpPickers.find('.range-start').datepicker('setDate',startDate);
                rpPickers.find('.range-end').datepicker('setDate', endDate);
                rangeA = fDate( startDate );
                rangeB = fDate( endDate );
                //send back to input or inputs
                if(rangeInput.length == 2){
                    rangeInput.eq(0).val(rangeA);
                    rangeInput.eq(1).val(rangeB);
            ...
            getStartDate: function(){
                return rpPickers.find('.range-start').datepicker('getDate');
            },

            getEndDate: function(){
                return rpPickers.find('.range-end').datepicker('getDate');
            },

            isVaidRange : function(){
                return rpPickers.find('.range-start').datepicker('getDate') != null  &&  rpPickers.find('.range-end').datepicker('getDate') !=null;
            }
