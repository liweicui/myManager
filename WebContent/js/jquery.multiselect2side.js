				...
				var htmlToAdd = 
					"<div class='ms2side__div'>" +
						...
						"<div class='ms2side__options'>" +
							...
							?
							("<p class='AddOne' title='添加选中的'>&rsaquo;</p>" +
							"<p class='AddAll' title='添加所有'>&raquo;</p>" +
							"<p class='RemoveOne' title='移除选中的'>&lsaquo;</p>" +
							"<p class='RemoveAll' title='移除所有'>&laquo;</p>")
							:
							("<p class='AddOne' title='添加选中的'>&lsaquo;</p>" +
							"<p class='AddAll' title='添加所有'>&laquo;</p>" +
							"<p class='RemoveOne' title='移除选中的'>&rsaquo;</p>" +
							"<p class='RemoveAll' title='移除所有'>&raquo;</p>")
							) +
						"</div>" +
						"<div class='ms2side__select'>" +
							((o.labeldx || rightSearch != false) ? ("<div class='ms2side__header'>" + (rightSearch != false ? rightSearch : (o.labeldx=='Selected'?'选中的游戏':o.labeldx)) + "</div>") : "") +
